//! Workspace manager for codebase indexing.
//!
//! This module provides the core workspace management functionality,
//! including file scanning, hash computation, checkpoint management,
